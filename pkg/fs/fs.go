...
var _ fs.FS = (*CamliFileSystem)(nil)
...
func (n *node) Open(req *fuse.OpenRequest, res *fuse.OpenResponse, intr fs.Intr) (fs.Handle, fuse.Error) {
...
func (nr *nodeReader) Read(req *fuse.ReadRequest, res *fuse.ReadResponse, intr fs.Intr) fuse.Error {
...
func (nr *nodeReader) Release(req *fuse.ReleaseRequest, intr fs.Intr) fuse.Error {
...
func (fs *CamliFileSystem) Root() (fs.Node, fuse.Error) {
	return fs.root, nil
}

func (fs *CamliFileSystem) Statfs(req *fuse.StatfsRequest, res *fuse.StatfsResponse, intr fs.Intr) fuse.Error {
...
func (fs *CamliFileSystem) newNodeFromBlobRef(root blob.Ref) (fs.Node, error) {
...
func (s staticFileNode) Read(req *fuse.ReadRequest, res *fuse.ReadResponse, intr fs.Intr) fuse.Error {
...
func (n staticFileNode) Getxattr(*fuse.GetxattrRequest, *fuse.GetxattrResponse, fs.Intr) fuse.Error {
	return fuse.ENODATA
}

func (n staticFileNode) Listxattr(*fuse.ListxattrRequest, *fuse.ListxattrResponse, fs.Intr) fuse.Error {
	return nil
}

func (n staticFileNode) Setxattr(*fuse.SetxattrRequest, fs.Intr) fuse.Error {
	return fuse.EPERM
}

func (n staticFileNode) Removexattr(*fuse.RemovexattrRequest, fs.Intr) fuse.Error {
	return fuse.EPERM
}
